...
// Control de seguridad: solo estudiantes autenticados
if (!isset($_SESSION['estudiante_autenticado']) || $_SESSION['estudiante_autenticado'] !== true) {
    header("Location: index.php");
    exit();
}
$nombre_estudiante = isset($_SESSION['estudiante_nombre']) ? $_SESSION['estudiante_nombre'] : 'Estudiante';
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Mis Notas - Instituto Paccioli</title>
...
.navbar {
    ...
    padding: 12px 40px;
    display: flex;
    justify-content: flex-end; /* Empuja el menú de usuario a la derecha */
    align-items: center;
...
<div class="navbar">
    <div class="brand">
        ...
        <div class="subtitle">Consulta de Calificaciones</div>
    </div>
    <div class="user-menu">
        <img src="https://cdn-icons-png.flaticon.com/512/3135/3135715.png" alt="Estudiante">
        <span><?php echo htmlspecialchars($nombre_estudiante); ?> ▾</span>
